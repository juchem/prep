...
**NOTE:** I strongly recommend you trying your own solution before peeking at the ones provided.
  ...
  2. [[ref]](2-edge_fill) Implement edge fill (four-way): suppose each number represents a color, suppose the currently selected color is 2 (the color that will be painted), and suppose you click on the _X_ (whose value is also 0) on the picture on the left. Your algorithm should end up with the picture on the right (as a follow up, do it in N dimensions):
  ...
  3. [[ref]](3-count_words) Find the number of words in a string
  4. [[ref]](4-binary_tree_reverse) Reverse a binary tree (left-right)
  5. [[ref]](5-most_overlapped_point) Given a list of intervals [begin,,i,,, end,,i,,], find a point which overlaps the most intervals
  6. [[ref]](6-set_intersection) Given a group of sets, find the intersection between them without using a hash-table
  7. [[ref]](7-binary_tree_depth) Calculate the depth of a binary tree (for practical reasons, assume a tree with a single element has depth = 1).
  8. [[ref]](8-is_binary_tree_balanced) Tell if a binary tree is balanced
  9. [[ref]](9-reverse_linked_list) Reverse a linked list
    1. iteratively
    2. recursively
  10. Given a tree, set the value of each node with the cumulative size of the sub-tree rooted at that node.
  11. [[ref]](11-binary_division) Implement division without using the division operator
  12. [[ref]](12-lru_cache) Implement a LRU (Least Recently Used) cache with limited size and fast look-up
  13. [[ref]](13-element-uniqueness) Determine element uniqueness in an array (find one element that appears more than once)
  14. [[ref]](14-shuffle) Shuffle an array with equal probability of generating any of the possible permutations
  ...
  27. [[ref]](27-string_permutations) Find all permutations of a string
  ...
  30. [[ref]](30-parenthesis_combinations) Generate all balanced parenthesis combinations for a given amount of parenthesis pairs. For each combination, determine the maximum nesting depth.
    * for 3 pairs:
  ...
  31. [[ref]](31-is_bianry_tree_symmetric) Find out if a binary tree is symmetric.
    * Symmetric:
  ...
  48. [[ref]](48-2sum_3sum) Given an array of integers and a target value, find:
  ...
  65. [[ref]](65-three_points_form_triangle) Tell if three points form a triangle
  66. [[ref]](66-deep_iterator) Implement a deep iterator over a list of nested lists having any depth.
    * Example:
  ...
  67. [[ref]](67-list_cycle) How do you detect a cycle in a linked list? How do you break it?
  ...
  71. [[ref]](71-cross_fill_zeroes) Given a bi-dimensional matrix of _1s_ and _0s_, write a function that, for every _0_ in the matrix, fills the whole row and column with _0s_.
  ...
  72. [[ref]](72-coin_probabilities) Given a list of probabilities for _N_ coins to come up with heads, list all possible outcomes and the probability for each one
  73. [[ref]](73-string_combinations) Find all _k_-sized subsets (without replacement) of a string (where _k_ <= string size)
    * You can output to stdout
  74. [[ref]](74-find_graph_components) Given a bi-dimensional matrix, find the number of different groups of values. A group is made of equal-valued elements adjacent to each other. Adjacency is four-way (up, down, left, right).
  ...
  77. [[ref]](77-array_shift) Given a sorted array with _n_ elements which has been shifted by _k_ positions, where _k < n_, find _k_. Examples:
  ...
  80. [[ref]](80-reverse_print_list) Print the elements of a linked list in reverse order
